...
def prepare_fc ():
    if not arcpy.Exists(pp_c.STATS_FC):       
        ...
        arcpy.management.JoinField(pp_c.STATS_FC, pp_c.STATS_COMMUNITY_NAME_COL, community_and_landcover_tbl, pp_c.LAND_COVER_COMMUNITY_NAME_COL, [s[0] for s in pp_c.LAND_COVER_STATS])
